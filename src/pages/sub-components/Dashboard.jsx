...
import { clearAllExperienceErrors } from "@/store/slices/experienceSlice";
...
const Dashboard = () => {
  ...
  console.log("experie", experience);
              ...
              <TabsContent className="grid min-[1050px]:grid-cols-2 gap-4">
                ...
                <Card>
                  <CardHeader className="px-7 flex items-center justify-between flex-row">
                    ...
                    <Button onClick={gotoMangeExperience} className="w-fit">
                      Manage Experience
                    </Button>
                  </CardHeader>
                  <CardContent>
