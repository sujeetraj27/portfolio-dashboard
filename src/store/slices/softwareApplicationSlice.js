...
export const getAllSoftwareApplications = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://mernstact-portfolio-backend-code-1.onrender.com/api/v1/softwareapplication/getall",
...
export const addNewSoftwareApplication = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://mernstact-portfolio-backend-code-1.onrender.com/api/v1/softwareapplication/add",
      data,
      {
        withCredentials: true,
...
export const deleteSoftwareApplication = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://mernstact-portfolio-backend-code-1.onrender.com/api/v1/softwareapplication/delete/${id}`,
      {
        withCredentials: true,
      }
    );
