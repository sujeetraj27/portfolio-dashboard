...
export const getAllSkills = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://mernstact-portfolio-backend-code-1.onrender.com/api/v1/skill/getall",
...
export const addNewSkill = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://mernstact-portfolio-backend-code-1.onrender.com/api/v1/skill/add",
      data,
      {
        withCredentials: true,
...
export const updateSkill = (id, proficiency) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `https://mernstact-portfolio-backend-code-1.onrender.com/api/v1/skill/update/${id}`,
      { proficiency },
      {
        withCredentials: true,
...
export const deleteSkill = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://mernstact-portfolio-backend-code-1.onrender.com/api/v1/skill/delete/${id}`,
      {
        withCredentials: true,
      }
    );
