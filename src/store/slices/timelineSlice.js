...
export const getAllTimeline = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://mernstact-portfolio-backend-code-1.onrender.com/api/v1/timeline/getall",
...
export const addNewTimeline = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://mernstact-portfolio-backend-code-1.onrender.com/api/v1/timeline/add",
      data,
      {
        withCredentials: true,
...
export const deleteTimeline = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://mernstact-portfolio-backend-code-1.onrender.com/api/v1/timeline/delete/${id}`,
      {
        withCredentials: true,
      }
    );
